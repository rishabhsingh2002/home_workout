...
import workout.home.homeworkout.databinding.FragmentAbsExerciseBinding
import workout.home.homeworkout.model.ExerciseModel
import java.util.*

class AbsExerciseFragment : Fragment(), TextToSpeech.OnInitListener {

    private var _binding: FragmentAbsExerciseBinding? = null
    ...
    //Time durations
    companion object {
        const val EXERCISE_TIME = 45000L
        const val REST_TIME = 15000L
    }
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAbsExerciseBinding.inflate(inflater, container, false)
        ...
        db.collection("abs").addSnapshotListener { value, error ->
            ...
            // Text to speech
            tts = TextToSpeech(context, this@AbsExerciseFragment as OnInitListener?)
        }
    ...
    private fun setUpRestView() {
        ...
        binding.llAbsRest.visibility = View.VISIBLE
    ...
    private fun setRestProgressBar() {
        restTimer = object : CountDownTimer(REST_TIME, 1000) {
            override fun onTick(p0: Long) {
                ...
                binding.btnSkipAbs.setOnClickListener {
                    restTimer?.cancel()
                    onFinish()
                }
            }
    ...
    private fun setUpExerciseView() {
        ...
        binding.llAbsRest.visibility = View.INVISIBLE
    ...
    private fun setExerciseProgressBar() {
        ...
        exerciseTimer = object : CountDownTimer(EXERCISE_TIME, 1000) {
            override fun onTick(p0: Long) {
                ...
                binding.btnNextExerciseAbs.setOnClickListener {
                    exerciseTimer?.cancel()
                    onFinish()
                }
            }
            ...
            override fun onFinish() {
                if (currentExercisePosition < listExerciseData?.size!! - 1) {
                    ...
                    Navigation.findNavController(binding.root)
                        .navigate(R.id.action_absExerciseFragment_to_finishFragment)
    ...
    private fun toolBarSetUp() {
        (activity as AppCompatActivity).setSupportActionBar(binding.toolbarAbsDetailedWorkout)
        if ((activity as AppCompatActivity).supportActionBar != null) {
            (activity as AppCompatActivity).supportActionBar?.setDisplayHomeAsUpEnabled(true)
        }
        binding.toolbarAbsDetailedWorkout.title = "Abs Exercise"
        binding.toolbarAbsDetailedWorkout.setNavigationOnClickListener {
