...
import workout.home.homeworkout.databinding.FragmentLegExerciseBinding
import workout.home.homeworkout.model.ExerciseModel
import java.util.*


class LegExerciseFragment : Fragment(), TextToSpeech.OnInitListener {
    ...
    override fun onCreateView(
        ...
        db.collection("leg").addSnapshotListener { value, error ->
            ...
            // Text to speech
            tts = TextToSpeech(context, this@LegExerciseFragment as TextToSpeech.OnInitListener?)
        }
    ...
    private fun setUpRestView() {
        ...
        binding.llLegRest.visibility = View.VISIBLE
    ...
    private fun setRestProgressBar() {
        restTimer = object : CountDownTimer(AbsExerciseFragment.REST_TIME, 1000) {
            override fun onTick(p0: Long) {
                ...
                binding.btnSkipLeg.setOnClickListener {
                    restTimer?.cancel()
                    onFinish()
                }
            }
    ...
    private fun setUpExerciseView() {
        ...
        binding.llLegRest.visibility = View.INVISIBLE
    ...
    private fun setExerciseProgressBar() {
        ...
        exerciseTimer = object : CountDownTimer(AbsExerciseFragment.EXERCISE_TIME, 1000) {
            override fun onTick(p0: Long) {
                ...
                binding.btnNextExerciseLeg.setOnClickListener {
                    exerciseTimer?.cancel()
                    onFinish()
                }
            }
            ...
            override fun onFinish() {
                if (currentExercisePosition < listExerciseData?.size!! - 1) {
                    ...
                    Navigation.findNavController(binding.root)
                        .navigate(R.id.action_legExerciseFragment_to_finishFragment)
    ...
    private fun toolBarSetUp() {
        (activity as AppCompatActivity).setSupportActionBar(binding.toolbarLegDetailedWorkout)
        if ((activity as AppCompatActivity).supportActionBar != null) {
            (activity as AppCompatActivity).supportActionBar?.setDisplayHomeAsUpEnabled(true)
        }
        binding.toolbarLegDetailedWorkout.title = "Leg Exercise"
        binding.toolbarLegDetailedWorkout.setNavigationOnClickListener {
