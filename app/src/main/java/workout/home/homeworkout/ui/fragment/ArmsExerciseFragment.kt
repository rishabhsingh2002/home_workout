...
import workout.home.homeworkout.databinding.FragmentArmsExerciseBinding
import workout.home.homeworkout.model.ExerciseModel
import java.util.*

class ArmsExerciseFragment : Fragment(), TextToSpeech.OnInitListener {
    private var _binding: FragmentArmsExerciseBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentArmsExerciseBinding.inflate(inflater, container, false)
        ...
        db.collection("arms").addSnapshotListener { value, error ->
            ...
            // Text to speech
            tts = TextToSpeech(context, this@ArmsExerciseFragment as TextToSpeech.OnInitListener?)
        }
    ...
    private fun setUpRestView() {
        ...
        binding.llArmsRest.visibility = View.VISIBLE
    ...
    private fun setRestProgressBar() {
        restTimer = object : CountDownTimer(AbsExerciseFragment.REST_TIME, 1000) {
            override fun onTick(p0: Long) {
                ...
                binding.btnSkipArms.setOnClickListener {
                    restTimer?.cancel()
                    onFinish()
                }
            }
    ...
    private fun setUpExerciseView() {
        ...
        binding.llArmsRest.visibility = View.INVISIBLE
    ...
    private fun setExerciseProgressBar() {
        ...
        exerciseTimer = object : CountDownTimer(AbsExerciseFragment.EXERCISE_TIME, 1000) {
            override fun onTick(p0: Long) {
                ...
                binding.btnNextExerciseArms.setOnClickListener {
                    exerciseTimer?.cancel()
                    onFinish()
                }
            }
            ...
            override fun onFinish() {
                if (currentExercisePosition < listExerciseData?.size!! - 1) {
                    ...
                    Navigation.findNavController(binding.root)
                        .navigate(R.id.action_armsExerciseFragment_to_finishFragment)
    ...
    private fun toolBarSetUp() {
        (activity as AppCompatActivity).setSupportActionBar(binding.toolbarArmsDetailedWorkout)
        if ((activity as AppCompatActivity).supportActionBar != null) {
            (activity as AppCompatActivity).supportActionBar?.setDisplayHomeAsUpEnabled(true)
        }
        binding.toolbarArmsDetailedWorkout.title = "Arms Exercise"
        binding.toolbarArmsDetailedWorkout.setNavigationOnClickListener {
